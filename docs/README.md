...
| [Cross-episode Context Retention](cross-episode-retain.md) | How retain preserves episode history, how to restart rows, and which artifacts and hosts support it. |
